...
# git clone the repo
git clone git@gitlab.crio.do:COHORT_ME_BUILDOUT_XMEME_ENROLL_1612436694845/utkarsh-sharma1399-me_buildout_xmeme.git

# cd to the cloned repo directory
cd utkarsh-sharma1399-me_buildout_xmeme
